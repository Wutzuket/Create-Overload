...
public class CPABlocks {
    ...
    static {
        PARTICLE_ACCELERATOR_CORE = ((BlockBuilder)Main
                .REGISTRATE
                .block("particle_accelerator_core", ParticleAcceleratorCoreBlock::new)
                .initialProperties(SharedProperties::softMetal)
                .properties((p) -> p
                        .strength(2.0F, 2.0F))
                .tag(new TagKey[]{AllBlockTags.SAFE_NBT.tag, AllBlockTags.WRENCH_PICKUP.tag})
                .item()
                .transform(ModelGen.customItemModel()))
                .register();
        ACCELERATOR_INPUT = ((BlockBuilder)Main
                .REGISTRATE
                ...
                .transform(ModelGen.customItemModel()))
                .register();
        ACCELERATOR_OUTPUT = ((BlockBuilder)Main
                .REGISTRATE
                ...
                .transform(ModelGen.customItemModel()))
                .register();
        FUSION_REACTOR_CASING = ((BlockBuilder)Main
                .REGISTRATE.block("fusion_reactor_casing", AcceleratorOutputBlock::new)
                .initialProperties(SharedProperties::softMetal)
                .properties((p) -> p
                        .strength(2.0F, 2.0F))
                .tag(new TagKey[]{AllBlockTags.SAFE_NBT.tag, AllBlockTags.WRENCH_PICKUP.tag})
                .item().transform(ModelGen.customItemModel())).register();
        FUSION_REACTOR_CORE = ((BlockBuilder)Main
                .REGISTRATE
                .block("fusion_reactor_core", ParticleAcceleratorCoreBlock::new)
                .initialProperties(SharedProperties::softMetal)
                .properties((p) -> p
                        .strength(2.0F, 2.0F))
                .tag(new TagKey[]{AllBlockTags.SAFE_NBT.tag, AllBlockTags.WRENCH_PICKUP.tag})
                ...
                .transform(ModelGen.customItemModel()))
                .register();
        FUSION_REACTOR_INPUT = ((BlockBuilder)Main
                .REGISTRATE
