...
public class RotatorWheelVisual extends KineticBlockEntityVisual<RotatorWheelBlockEntity> implements SimpleDynamicVisual {
    ...
    public RotatorWheelVisual(VisualizationContext context, RotatorWheelBlockEntity blockEntity, float partialTick) {
        ...
        shaft.setup(RotatorWheelVisual.this.blockEntity)
                .setPosition(getVisualPosition())
                .rotateToFace(axis)
                .setChanged();

        wheel = instancerProvider().instancer(InstanceTypes.TRANSFORMED, Models.partial(CPAPartialModels.ROTATORWHEEL))
                .createInstance();
